...
public class BlockedDatesByHostResponse {

    @NotNull(message = "Id of blocked dates by host can not be null")
    private Long id;
    ...
    public BlockedDatesByHostResponse() {
    }
    ...
    public @NotNull(message = "Id of blocked dates by host can not be null") Long getId() {
        return id;
    }

    public void setId(@NotNull(message = "Id of blocked dates by host can not be null") Long id) {
        this.id = id;
    }
}
